...
import com.test.infra.model.Filter;
...
import static com.test.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.test.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.test.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.test.infra.model.SortOrder.DESCENDING
                            : com.test.infra.model.SortOrder.UNSORTED;
                }
